...
class WanImageToVideo_ISO(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(node_id='WanImageToVideo_ISO', category='conditioning/video_models', inputs=[io.Conditioning.Input('positive'), io.Conditioning.Input('negative'), io.Vae.Input('vae'), io.Int.Input('width', default=832, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('height', default=480, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('length', default=81, min=1, max=nodes.MAX_RESOLUTION, step=4), io.Int.Input('batch_size', default=1, min=1, max=4096), io.ClipVisionOutput.Input('clip_vision_output', optional=True), io.Image.Input('start_image', optional=True)], outputs=[io.Conditioning.Output(display_name='positive'), io.Conditioning.Output(display_name='negative'), io.Latent.Output(display_name='latent')])
...
class WanFunControlToVideo_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='WanFunControlToVideo_ISO', category='conditioning/video_models', inputs=[io.Conditioning.Input('positive'), io.Conditioning.Input('negative'), io.Vae.Input('vae'), io.Int.Input('width', default=832, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('height', default=480, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('length', default=81, min=1, max=nodes.MAX_RESOLUTION, step=4), io.Int.Input('batch_size', default=1, min=1, max=4096), io.ClipVisionOutput.Input('clip_vision_output', optional=True), io.Image.Input('start_image', optional=True), io.Image.Input('control_video', optional=True)], outputs=[io.Conditioning.Output(display_name='positive'), io.Conditioning.Output(display_name='negative'), io.Latent.Output(display_name='latent')])
...
class WanFunInpaintToVideo_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='WanFunInpaintToVideo_ISO', category='conditioning/video_models', inputs=[io.Conditioning.Input('positive'), io.Conditioning.Input('negative'), io.Vae.Input('vae'), io.Int.Input('width', default=832, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('height', default=480, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('length', default=81, min=1, max=nodes.MAX_RESOLUTION, step=4), io.Int.Input('batch_size', default=1, min=1, max=4096), io.ClipVisionOutput.Input('clip_vision_output', optional=True), io.Image.Input('start_image', optional=True), io.Image.Input('end_image', optional=True)], outputs=[io.Conditioning.Output(display_name='positive'), io.Conditioning.Output(display_name='negative'), io.Latent.Output(display_name='latent')])
    ...
    def execute(cls, positive, negative, vae, width, height, length, batch_size, start_image=None, end_image=None, clip_vision_output=None) -> io.NodeOutput:
        flfv = WanFirstLastFrameToVideo_ISO()
...
class WanVaceToVideo_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='WanVaceToVideo_ISO', category='conditioning/video_models', inputs=[io.Conditioning.Input('positive'), io.Conditioning.Input('negative'), io.Vae.Input('vae'), io.Int.Input('width', default=832, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('height', default=480, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('length', default=81, min=1, max=nodes.MAX_RESOLUTION, step=4), io.Int.Input('batch_size', default=1, min=1, max=4096), io.Float.Input('strength', default=1.0, min=0.0, max=1000.0, step=0.01), io.Image.Input('control_video', optional=True), io.Mask.Input('control_masks', optional=True), io.Image.Input('reference_image', optional=True)], outputs=[io.Conditioning.Output(display_name='positive'), io.Conditioning.Output(display_name='negative'), io.Latent.Output(display_name='latent'), io.Int.Output(display_name='trim_latent')])
...
class TrimVideoLatent_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='TrimVideoLatent_ISO', category='latent/video', inputs=[io.Latent.Input('samples'), io.Int.Input('trim_amount', default=0, min=0, max=99999)], outputs=[io.Latent.Output()])
...
class WanCameraImageToVideo_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='WanCameraImageToVideo_ISO', category='conditioning/video_models', inputs=[io.Conditioning.Input('positive'), io.Conditioning.Input('negative'), io.Vae.Input('vae'), io.Int.Input('width', default=832, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('height', default=480, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('length', default=81, min=1, max=nodes.MAX_RESOLUTION, step=4), io.Int.Input('batch_size', default=1, min=1, max=4096), io.ClipVisionOutput.Input('clip_vision_output', optional=True), io.Image.Input('start_image', optional=True), io.WanCameraEmbedding.Input('camera_conditions', optional=True)], outputs=[io.Conditioning.Output(display_name='positive'), io.Conditioning.Output(display_name='negative'), io.Latent.Output(display_name='latent')])
...
class WanPhantomSubjectToVideo_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='WanPhantomSubjectToVideo_ISO', category='conditioning/video_models', inputs=[io.Conditioning.Input('positive'), io.Conditioning.Input('negative'), io.Vae.Input('vae'), io.Int.Input('width', default=832, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('height', default=480, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('length', default=81, min=1, max=nodes.MAX_RESOLUTION, step=4), io.Int.Input('batch_size', default=1, min=1, max=4096), io.Image.Input('images', optional=True)], outputs=[io.Conditioning.Output(display_name='positive'), io.Conditioning.Output(display_name='negative_text'), io.Conditioning.Output(display_name='negative_img_text'), io.Latent.Output(display_name='latent')])
...
def process_tracks(tracks_np: np.ndarray, frame_size: Tuple[int, int], num_frames, quant_multi: int=8, **kwargs):
    ...
    out_l = torch.repeat_interleave(out_l, b, dim=0)[1::a]
...
def _patch_motion_single(tracks: torch.FloatTensor, vid: torch.FloatTensor, temperature: float, vae_divide: tuple, topk: int):
    ...
    tracks_align = (tracks_pad * visible_pad).view(T - 1, 4, *tracks_pad.shape[2:]).sum(1) / (visible_align + 1e-05)
    ...
    grid_mode = 'bilinear'
    point_feature = torch.nn.functional.grid_sample(vid.permute(1, 0, 2, 3)[:1], tracks_n[:, :1].type(vid.dtype), mode=grid_mode, padding_mode='zeros', align_corners=False)
...
def patch_motion(tracks: torch.FloatTensor, vid: torch.FloatTensor, temperature: float=220.0, vae_divide: tuple=(4, 16), topk: int=2):
    B = len(tracks)
    out_masks = []
    out_features = []
    for b in range(B):
        mask, feature = _patch_motion_single(tracks[b], vid[b], temperature, vae_divide, topk)
...
class WanTrackToVideo_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='WanTrackToVideo_ISO', category='conditioning/video_models', inputs=[io.Conditioning.Input('positive'), io.Conditioning.Input('negative'), io.Vae.Input('vae'), io.String.Input('tracks', multiline=True, default='[]'), io.Int.Input('width', default=832, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('height', default=480, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('length', default=81, min=1, max=nodes.MAX_RESOLUTION, step=4), io.Int.Input('batch_size', default=1, min=1, max=4096), io.Float.Input('temperature', default=220.0, min=1.0, max=1000.0, step=0.1), io.Int.Input('topk', default=2, min=1, max=10), io.Image.Input('start_image'), io.ClipVisionOutput.Input('clip_vision_output', optional=True)], outputs=[io.Conditioning.Output(display_name='positive'), io.Conditioning.Output(display_name='negative'), io.Latent.Output(display_name='latent')])

    @classmethod
    def execute(cls, positive, negative, vae, tracks, width, height, length, batch_size, temperature, topk, start_image=None, clip_vision_output=None) -> io.NodeOutput:
        tracks_data = parse_json_tracks(tracks)
        if not tracks_data:
            return WanImageToVideo_ISO().execute(positive, negative, vae, width, height, length, batch_size, start_image=start_image, clip_vision_output=clip_vision_output)
        latent = torch.zeros([batch_size, 16, (length - 1) // 4 + 1, height // 8, width // 8], device=comfy.model_management.intermediate_device())
        ...
        if start_image is not None:
            ...
            res = patch_motion(processed_tracks, y, temperature=temperature, topk=topk, vae_divide=(4, 16))
...
def get_audio_embed_bucket_fps(audio_embed, fps=16, batch_frames=81, m=0, video_rate=30):
    ...
    batch_idx = get_sample_indices(original_fps=video_rate, total_frames=audio_frame_num + padd_audio_num, target_fps=fps, num_sample=bucket_num, fixed_start=0)
    batch_audio_eb = []
...
class WanSoundImageToVideo_ISO(io.ComfyNode):
    ...
    def execute(cls, positive, negative, vae, width, height, length, batch_size, ref_image=None, audio_encoder_output=None, control_video=None, ref_motion=None) -> io.NodeOutput:
        positive, negative, out_latent, frame_offset = wan_sound_to_video(positive, negative, vae, width, height, length, batch_size, ref_image=ref_image, audio_encoder_output=audio_encoder_output, control_video=control_video, ref_motion=ref_motion)
        return io.NodeOutput(positive, negative, out_latent)
...
class WanSoundImageToVideoExtend_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='WanSoundImageToVideoExtend_ISO', category='conditioning/video_models', inputs=[io.Conditioning.Input('positive'), io.Conditioning.Input('negative'), io.Vae.Input('vae'), io.Int.Input('length', default=77, min=1, max=nodes.MAX_RESOLUTION, step=4), io.Latent.Input('video_latent'), io.AudioEncoderOutput.Input('audio_encoder_output', optional=True), io.Image.Input('ref_image', optional=True), io.Image.Input('control_video', optional=True)], outputs=[io.Conditioning.Output(display_name='positive'), io.Conditioning.Output(display_name='negative'), io.Latent.Output(display_name='latent')])
    ...
    def execute(cls, positive, negative, vae, length, video_latent, ref_image=None, audio_encoder_output=None, control_video=None) -> io.NodeOutput:
        ...
        positive, negative, out_latent, frame_offset = wan_sound_to_video(positive, negative, vae, width, height, length, batch_size, frame_offset=frame_offset, ref_image=ref_image, audio_encoder_output=audio_encoder_output, control_video=control_video, ref_motion=None, ref_motion_latent=video_latent)
        return io.NodeOutput(positive, negative, out_latent)
...
class WanHuMoImageToVideo_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='WanHuMoImageToVideo_ISO', category='conditioning/video_models', inputs=[io.Conditioning.Input('positive'), io.Conditioning.Input('negative'), io.Vae.Input('vae'), io.Int.Input('width', default=832, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('height', default=480, min=16, max=nodes.MAX_RESOLUTION, step=16), io.Int.Input('length', default=97, min=1, max=nodes.MAX_RESOLUTION, step=4), io.Int.Input('batch_size', default=1, min=1, max=4096), io.AudioEncoderOutput.Input('audio_encoder_output', optional=True), io.Image.Input('ref_image', optional=True)], outputs=[io.Conditioning.Output(display_name='positive'), io.Conditioning.Output(display_name='negative'), io.Latent.Output(display_name='latent')], is_experimental=True)
...
class WanExtension_ISO(ComfyExtension):

    @override
    async def get_node_list(self) -> list[type[io.ComfyNode]]:
        return [WanTrackToVideo_ISO, WanImageToVideo_ISO, WanFunControlToVideo_ISO, Wan22FunControlToVideo_ISO, WanFunInpaintToVideo_ISO, WanFirstLastFrameToVideo_ISO, WanVaceToVideo_ISO, TrimVideoLatent_ISO, WanCameraImageToVideo_ISO, WanPhantomSubjectToVideo_ISO, WanSoundImageToVideo_ISO, WanSoundImageToVideoExtend_ISO, WanHuMoImageToVideo_ISO, WanAnimateToVideo_ISO, Wan22ImageToVideoLatent_ISO]

async def comfy_entrypoint() -> WanExtension_ISO:
    return WanExtension_ISO()
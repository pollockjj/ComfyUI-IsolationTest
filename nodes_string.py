...
class StringConcatenate_ISO(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(node_id='StringConcatenate_ISO', display_name='Concatenate_ISO', category='utils/string', inputs=[io.String.Input('string_a', multiline=True), io.String.Input('string_b', multiline=True), io.String.Input('delimiter', multiline=False, default='')], outputs=[io.String.Output()])
...
class StringSubstring_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='StringSubstring_ISO', display_name='Substring_ISO', category='utils/string', inputs=[io.String.Input('string', multiline=True), io.Int.Input('start'), io.Int.Input('end')], outputs=[io.String.Output()])
...
class StringLength_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='StringLength_ISO', display_name='Length_ISO', category='utils/string', inputs=[io.String.Input('string', multiline=True)], outputs=[io.Int.Output(display_name='length')])
...
class CaseConverter_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='CaseConverter_ISO', display_name='Case Converter_ISO', category='utils/string', inputs=[io.String.Input('string', multiline=True), io.Combo.Input('mode', options=['UPPERCASE', 'lowercase', 'Capitalize', 'Title Case'])], outputs=[io.String.Output()])
...
class StringTrim_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='StringTrim_ISO', display_name='Trim_ISO', category='utils/string', inputs=[io.String.Input('string', multiline=True), io.Combo.Input('mode', options=['Both', 'Left', 'Right'])], outputs=[io.String.Output()])
...
class StringReplace_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='StringReplace_ISO', display_name='Replace_ISO', category='utils/string', inputs=[io.String.Input('string', multiline=True), io.String.Input('find', multiline=True), io.String.Input('replace', multiline=True)], outputs=[io.String.Output()])
...
class StringContains_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='StringContains_ISO', display_name='Contains_ISO', category='utils/string', inputs=[io.String.Input('string', multiline=True), io.String.Input('substring', multiline=True), io.Boolean.Input('case_sensitive', default=True)], outputs=[io.Boolean.Output(display_name='contains')])
...
class RegexMatch_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='RegexMatch_ISO', display_name='Regex Match_ISO', category='utils/string', inputs=[io.String.Input('string', multiline=True), io.String.Input('regex_pattern', multiline=True), io.Boolean.Input('case_insensitive', default=True), io.Boolean.Input('multiline', default=False), io.Boolean.Input('dotall', default=False)], outputs=[io.Boolean.Output(display_name='matches')])
...
class RegexExtract_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return io.Schema(node_id='RegexExtract_ISO', display_name='Regex Extract_ISO', category='utils/string', inputs=[io.String.Input('string', multiline=True), io.String.Input('regex_pattern', multiline=True), io.Combo.Input('mode', options=['First Match', 'All Matches', 'First Group', 'All Groups']), io.Boolean.Input('case_insensitive', default=True), io.Boolean.Input('multiline', default=False), io.Boolean.Input('dotall', default=False), io.Int.Input('group_index', default=1, min=0, max=100)], outputs=[io.String.Output()])

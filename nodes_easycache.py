...
class EasyCacheNode_ISO(io.ComfyNode):
    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(node_id='EasyCache_ISO', display_name='EasyCache_ISO', description='Native EasyCache implementation.', category='advanced/debug/model', is_experimental=True, inputs=[io.Model.Input('model', tooltip='The model to add EasyCache to.'), io.Float.Input('reuse_threshold', min=0.0, default=0.2, max=3.0, step=0.01, tooltip='The threshold for reusing cached steps.'), io.Float.Input('start_percent', min=0.0, default=0.15, max=1.0, step=0.01, tooltip='The relative sampling step to begin use of EasyCache.'), io.Float.Input('end_percent', min=0.0, default=0.95, max=1.0, step=0.01, tooltip='The relative sampling step to end use of EasyCache.'), io.Boolean.Input('verbose', default=False, tooltip='Whether to log verbose information.')], outputs=[io.Model.Output(tooltip='The model with EasyCache.')])
...
class LazyCacheNode_ISO(io.ComfyNode):
    ...
    @classmethod
    def define_schema(cls) -> io.Schema:
        return io.Schema(node_id='LazyCache_ISO', display_name='LazyCache_ISO', description="A homebrew version of EasyCache - even 'easier' version of EasyCache to implement. Overall works worse than EasyCache, but better in some rare cases AND universal compatibility with everything in ComfyUI.", category='advanced/debug/model', is_experimental=True, inputs=[io.Model.Input('model', tooltip='The model to add LazyCache to.'), io.Float.Input('reuse_threshold', min=0.0, default=0.2, max=3.0, step=0.01, tooltip='The threshold for reusing cached steps.'), io.Float.Input('start_percent', min=0.0, default=0.15, max=1.0, step=0.01, tooltip='The relative sampling step to begin use of LazyCache.'), io.Float.Input('end_percent', min=0.0, default=0.95, max=1.0, step=0.01, tooltip='The relative sampling step to end use of LazyCache.'), io.Boolean.Input('verbose', default=False, tooltip='Whether to log verbose information.')], outputs=[io.Model.Output(tooltip='The model with LazyCache.')])
...
class EasyCacheExtension_ISO(ComfyExtension):

    async def get_node_list(self) -> list[type[io.ComfyNode]]:
        return [EasyCacheNode_ISO, LazyCacheNode_ISO]

def comfy_entrypoint():
    return EasyCacheExtension_ISO()
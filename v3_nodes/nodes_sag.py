...
_orig = importlib.import_module('comfy_extras.nodes_sag')

class SelfAttentionGuidance_ISO(io.ComfyNode):
    @classmethod
    def define_schema(cls) -> io.Schema:
        orig_cls = getattr(_orig, 'SelfAttentionGuidance')
        orig_schema = orig_cls.define_schema()
        schema = copy.deepcopy(orig_schema)
        base_node_id = schema.node_id or 'SelfAttentionGuidance'
        base_display = schema.display_name or 'Self-Attention Guidance'
...
__all__ = ['SelfAttentionGuidance_ISO']